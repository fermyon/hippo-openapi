...
*CertificateApi* | [**api_certificate_id_get**](docs/CertificateApi.md#api_certificate_id_get) | **GET** /api/certificate/{id} |
...
*EnvironmentVariableApi* | [**api_environmentvariable_id_get**](docs/EnvironmentVariableApi.md#api_environmentvariable_id_get) | **GET** /api/environmentvariable/{id} |
...
*RevisionApi* | [**api_revision_id_get**](docs/RevisionApi.md#api_revision_id_get) | **GET** /api/revision/{id} |

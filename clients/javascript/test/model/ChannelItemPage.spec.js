...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HippoWeb.ChannelItemPage();
  });
  ...
  describe('ChannelItemPage', function() {
    it('should create an instance of ChannelItemPage', function() {
      // uncomment below and update the code to test ChannelItemPage
      //var instance = new HippoWeb.ChannelItemPage();
      //expect(instance).to.be.a(HippoWeb.ChannelItemPage);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HippoWeb.CertificateItem();
  });
  ...
  describe('CertificateItem', function() {
    it('should create an instance of CertificateItem', function() {
      // uncomment below and update the code to test CertificateItem
      //var instance = new HippoWeb.CertificateItem();
      //expect(instance).to.be.a(HippoWeb.CertificateItem);
    });

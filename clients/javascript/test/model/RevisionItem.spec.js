...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HippoWeb.RevisionItem();
  });
  ...
  describe('RevisionItem', function() {
    it('should create an instance of RevisionItem', function() {
      // uncomment below and update the code to test RevisionItem
      //var instance = new HippoWeb.RevisionItem();
      //expect(instance).to.be.a(HippoWeb.RevisionItem);
    });

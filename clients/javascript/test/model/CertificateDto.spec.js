...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HippoWeb.CertificateDto();
  });
  ...
  describe('CertificateDto', function() {
    it('should create an instance of CertificateDto', function() {
      // uncomment below and update the code to test CertificateDto
      //var instance = new HippoWeb.CertificateDto();
      //expect(instance).to.be.a(HippoWeb.CertificateDto);
    });

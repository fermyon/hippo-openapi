...
(function(root, factory) {
  ...
  describe('AppItem', function() {
    it('should create an instance of AppItem', function() {
      // uncomment below and update the code to test AppItem
      //var instance = new HippoWeb.AppItem();
      //expect(instance).to.be.a(HippoWeb.AppItem);
    });

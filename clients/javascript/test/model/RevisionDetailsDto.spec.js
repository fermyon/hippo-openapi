...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HippoWeb.RevisionDetailsDto();
  });
  ...
  describe('RevisionDetailsDto', function() {
    it('should create an instance of RevisionDetailsDto', function() {
      // uncomment below and update the code to test RevisionDetailsDto
      //var instance = new HippoWeb.RevisionDetailsDto();
      //expect(instance).to.be.a(HippoWeb.RevisionDetailsDto);
    });

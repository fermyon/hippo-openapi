...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HippoWeb.RevisionItemPage();
  });
  ...
  describe('RevisionItemPage', function() {
    it('should create an instance of RevisionItemPage', function() {
      // uncomment below and update the code to test RevisionItemPage
      //var instance = new HippoWeb.RevisionItemPage();
      //expect(instance).to.be.a(HippoWeb.RevisionItemPage);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HippoWeb.RevisionDto();
  });
  ...
  describe('RevisionDto', function() {
    it('should create an instance of RevisionDto', function() {
      // uncomment below and update the code to test RevisionDto
      //var instance = new HippoWeb.RevisionDto();
      //expect(instance).to.be.a(HippoWeb.RevisionDto);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HippoWeb.CertificateItemPage();
  });
  ...
  describe('CertificateItemPage', function() {
    it('should create an instance of CertificateItemPage', function() {
      // uncomment below and update the code to test CertificateItemPage
      //var instance = new HippoWeb.CertificateItemPage();
      //expect(instance).to.be.a(HippoWeb.CertificateItemPage);
    });

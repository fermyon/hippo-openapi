...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HippoWeb.StringPage();
  });
  ...
  describe('StringPage', function() {
    it('should create an instance of StringPage', function() {
      // uncomment below and update the code to test StringPage
      //var instance = new HippoWeb.StringPage();
      //expect(instance).to.be.a(HippoWeb.StringPage);
    });

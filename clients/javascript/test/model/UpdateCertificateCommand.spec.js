...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HippoWeb.UpdateCertificateCommand();
  });
  ...
  describe('UpdateCertificateCommand', function() {
    it('should create an instance of UpdateCertificateCommand', function() {
      // uncomment below and update the code to test UpdateCertificateCommand
      //var instance = new HippoWeb.UpdateCertificateCommand();
      //expect(instance).to.be.a(HippoWeb.UpdateCertificateCommand);
    });

...
(function(root, factory) {
  ...
  describe('AppDto', function() {
    it('should create an instance of AppDto', function() {
      // uncomment below and update the code to test AppDto
      //var instance = new HippoWeb.AppDto();
      //expect(instance).to.be.a(HippoWeb.AppDto);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HippoWeb.CreateCertificateCommand();
  });
  ...
  describe('CreateCertificateCommand', function() {
    it('should create an instance of CreateCertificateCommand', function() {
      // uncomment below and update the code to test CreateCertificateCommand
      //var instance = new HippoWeb.CreateCertificateCommand();
      //expect(instance).to.be.a(HippoWeb.CreateCertificateCommand);
    });

...
*ChannelApi* | [**ApiChannelIdPatch**](docs/ChannelApi.md#apichannelidpatch) | **Patch** /api/channel/{id} | 
*ChannelApi* | [**ApiChannelIdPut**](docs/ChannelApi.md#apichannelidput) | **Put** /api/channel/{id} | 
*ChannelApi* | [**ApiChannelLogsIdGet**](docs/ChannelApi.md#apichannellogsidget) | **Get** /api/channel/logs/{id} | 
*ChannelApi* | [**ApiChannelPost**](docs/ChannelApi.md#apichannelpost) | **Post** /api/channel | 
*JobStatusApi* | [**ApiJobstatusChannelIdGet**](docs/JobStatusApi.md#apijobstatuschannelidget) | **Get** /api/jobstatus/{channelId} | 

...
// ApplicationChannelSummary struct for ApplicationChannelSummary
type ApplicationChannelSummary struct {
	Id string `json:"id"`
...
func NewApplicationChannelSummary(id string, name string) *ApplicationChannelSummary {
	this := ApplicationChannelSummary{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o *ApplicationChannelSummary) SetActiveRevisionNumberNil() {
...
func (o ApplicationChannelSummary) MarshalJSON() ([]byte, error) {
...
type NullableApplicationChannelSummary struct {
	value *ApplicationChannelSummary
	isSet bool
}

func (v NullableApplicationChannelSummary) Get() *ApplicationChannelSummary {
	return v.value
}

func (v *NullableApplicationChannelSummary) Set(val *ApplicationChannelSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationChannelSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationChannelSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationChannelSummary(val *ApplicationChannelSummary) *NullableApplicationChannelSummary {
	return &NullableApplicationChannelSummary{value: val, isSet: true}
}

func (v NullableApplicationChannelSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationChannelSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true

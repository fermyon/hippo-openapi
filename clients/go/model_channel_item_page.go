...
// SetItems gets a reference to the given []ChannelItem and assigns it to the Items field.
...
func (o *ChannelItemPage) SetPageIndexNil() {
	o.PageIndex.Set(nil)
}
...
func (o *ChannelItemPage) SetPageSizeNil() {
	o.PageSize.Set(nil)
}
...
func (o *ChannelItemPage) SetIsLastPageNil() {

...
func (r ApiApiJobstatusGetRequest) Execute() ([]ChannelJobStatus, *http.Response, error) {
...
func (a *JobStatusApiService) ApiJobstatusGetExecute(r ApiApiJobstatusGetRequest) ([]ChannelJobStatus, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ChannelJobStatus
	)

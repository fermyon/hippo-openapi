...
// SetItems gets a reference to the given []AppItem and assigns it to the Items field.
...
func (o *AppItemPage) SetPageIndexNil() {
	o.PageIndex.Set(nil)
}
...
func (o *AppItemPage) SetPageSizeNil() {
	o.PageSize.Set(nil)
}
...
func (o *AppItemPage) SetIsLastPageNil() {
